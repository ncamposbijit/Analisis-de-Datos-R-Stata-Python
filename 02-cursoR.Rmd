...
-  **Flexible y reproducible:** garantiza reproducibilidad, es flexible
...
-   **Objetos:** Cualquier cosa que guardes en R. Por ejemplo: bases de
    datos, variables, listas de nombres, gráficos.
...
Las fundamentales son: *Scripts, Console, 
...
idea es utilizar RStudio de la forma mas intuitiva posible. 

#### Escribir comentarios

Es muy importante escribir comentarios a lo largo de los códigos. Tambíen es importante saber escribir **buenos** comentarios. Una buena guía que habla un poco de eso y de muchas cosas más es: [Code and Data for the Social Sciences: A Practitioner's Guide](https://web.stanford.edu/~gentzkow/research/CodeAndData.pdf).
